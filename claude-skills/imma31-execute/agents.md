...
These templates are used by `/imma31-execute` and `/imma31-review`. Read this file and inject the appropriate template into each agent's prompt, filling the `{{PLACEHOLDER}}` values.
